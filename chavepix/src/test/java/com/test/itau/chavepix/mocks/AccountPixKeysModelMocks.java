...
//        PixKeyModel pixKeyModel = new PixKeyModel(pixKeyDTO.getKeyValue(), KeyTypeModel.valueOf(pixKeyDTO.getKeyType().name()));
...
//                PersonTypeModel.valueOf(pixKeyDTO.getPersonType().name()),
//                list);
//        return mock;
//    }
//
